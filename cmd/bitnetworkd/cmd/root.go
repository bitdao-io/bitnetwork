...
// main function.
func NewRootCmd() (*cobra.Command, cfgParams.EncodingConfig) {
	...
	rootCmd := &cobra.Command{
		...
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			customTemplate, customBitNetworkConfig := initAppConfig()
			return server.InterceptConfigsPreRunHandler(cmd, customTemplate, customBitNetworkConfig)
		},
	}
...
func initRootCmd(rootCmd *cobra.Command, encodingConfig cfgParams.EncodingConfig) {
	cfg := sdk.GetConfig()
...
type appCreator struct {
	encCfg cfgParams.EncodingConfig
}
